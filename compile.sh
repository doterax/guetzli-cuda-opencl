...
nvcc -D__USE_OPENCL__ -I"./" -I"/usr/local/cuda/include" --extra-warnings -Werror --verbose -ftz=true -prec-div=false -prec-sqrt=false -arch=compute_30 -O3 --machine $1 $2 -ptx -o clguetzli/clguetzli.cu.ptx$1  clguetzli/clguetzli.cu
